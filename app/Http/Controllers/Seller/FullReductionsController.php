...
class FullReductionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->handle($this->getService('base')->addDat($this->modelName, ['store_id','name','money','use_money','start_time','end_time']));
    }

    public function update(Request $request, $id)
    {
        $storeId = $this->getService('Store')->getStoreId()['data'];
        return $this->handle($this->getService('base')->editDat($this->modelName, $id, ['name','money','use_money','start_time','end_time'], ['store_id'=>$storeId]));
    }
