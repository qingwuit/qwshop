<template>
    <div class="qingwu">
        ...
        <div class="admin_table_handle_btn">
            <a-button @click="$router.push('/Admin/integral_goods/form')" type="primary" icon="plus">添加商品</a-button>
        ...
        <div class="admin_table_list">
            <a-table :columns="columns" :data-source="list" :pagination="false" :row-selection="{ selectedRowKeys: selectedRowKeys, onChange: onSelectChange }" row-key="id">
                ...
                <span slot="action" slot-scope="rows">
                    <a-button icon="read" @click="$router.push('/integral/goods/'+rows.id)">查看</a-button>
                    <a-button icon="edit" @click="$router.push('/Admin/integral_goods/form/'+rows.id)">编辑</a-button>
                </span>
            </a-table>
...
export default {
    ...
    methods: {
        ...
        del(){
            ...
            this.$confirm({
                ...
                onOk:()=> {
                    ...
                    this.$delete(this.$api.adminIntegralGoods+'/'+ids).then(res=>{
                        if(res.code == 200){
                            this.onload();
        ...
        onload(){
            this.$get(this.$api.adminIntegralGoods,this.params).then(res=>{
