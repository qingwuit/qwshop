            ...
            <div class="admin_card" >
                ...
                <div class="content">
                    <el-row :gutter="22">
                        ...
                        <el-col :span="8">
                            <div class="sort_list">
                                <div class="list_title">店铺销售额排名</div>
                                <div class="list_block" v-for="v in 6" :key="v"><em style="color:#999;float:right;">{{data.list[v-1]?data.list[v-1]['orders_count']:'-'}}</em><span>{{v}}</span><div style="width: 70%;display: inline-block;height: 20px;overflow: hidden;font-size:14px;line-height: 28px;">{{data.list[v-1]?data.list[v-1]['store_name']:'-'}}</div></div>
