<template>
    <div class="qingwu">
        <div class="admin_table_page_title">属性规格</div>
        <div class="unline underm"></div>

        <div class="admin_table_handle_btn">
            <a-button @click="$router.push('/Seller/goods_attrs/form')" type="primary" icon="plus">添加</a-button>
...
export default {
    ...
    methods: {
        ...
        del(){
            ...
            this.$confirm({
                ...
                onOk:()=> {
                    ...
                    this.$delete(this.$api.sellerGoodsAttrs+'/'+ids).then(res=>{
                        if(res.code == 200){
                            this.onload();
        ...
        onload(){
            this.$get(this.$api.sellerGoodsAttrs,this.params).then(res=>{
