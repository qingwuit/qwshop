<template>
    <div class="qingwu">
        <div class="admin_table_page_title"><a-button @click="$router.back()" class="float_right" icon="arrow-left">返回</a-button>分销日志</div>
...
export default {
    ...
    methods: {
        ...
        onload(){
            this.$get(this.$api.sellerDistributionLogs,this.params).then(res=>{
