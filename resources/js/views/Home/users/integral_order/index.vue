              ...
              <div class="order_list" v-if="list.length>0">
                <div class="order_item" v-for="(v,k) in list" :key="k">
                    ...
                    <div class="order_item_btn" v-show="v.order_status!=6 || v.order_status !=0">
                        <div class="default_btn" v-if="v.order_status>2 || v.order_status==6 " @click="get_order_info(v.id)">查看物流</div>
...
export default {
    ...
    methods: {
        ...
        onload(){
            this.$get(this.$api.homeIntegralOrder,this.params).then(res=>{
                this.list = res.data.data;
                this.total = res.data.total;
            })
        },
        get_order_info(id){
            this.$get(this.$api.homeIntegralOrder+'/get_order_info/'+id).then(res=>{
                this.visible = true;
