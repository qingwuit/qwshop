...
Route::namespace('App')->prefix('App')->group(function(){
    ...
    Route::get('/index','IndexController@index'); // 首页数据
    Route::get('/goods_classes/get_goods_classes','GoodsClassController@get_goods_classes'); // 获取栏目信息
    Route::get('/goods_classes/get_goods_class_children/{id}','GoodsClassController@get_goods_class_children'); // 获取栏目信息2
    Route::get('/stores/get_stores','StoreController@get_stores'); // 获取店铺列表
    Route::get('/store/{id}','StoreController@get_store_info'); // 店铺首页

    Route::get('/goods/goods_info/{id}','GoodsController@goods_info'); // 获取商品详情
    Route::get('/goods/comment_statistics/{id}','GoodsController@goods_comment_statistics'); // 获取商品评论统计
    Route::get('/goods/comments/{id}','GoodsController@goods_comments'); // 获取商品评论列表
    Route::post('/goods/search/all','GoodsController@goods_search'); // 搜索商品列表
    ...
    Route::group(['middleware'=>'jwt.user'],function(){
        ...
        Route::apiResource('money_logs','MoneyLogController')->except(['update','show','store','destroy']); // 资金变动
